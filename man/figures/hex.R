sticker(
  ...
  url = "github.com/Lingtax/rmdrive",   # url at the bottom
  u_color = "white",                    # color of url at the bottom
  u_size = 3.5,                         # size of url at the bottom
  filename = "rmdrive_hex.png"          # location to save the image
)
