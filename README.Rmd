...
- `vignette("trackdow-features")` - for detailed description of the functions arguments and features
- `vignette("trackdow-workflow")` - for a workflow example and a discussion about collaboration on prose and code
- `vignette("trackdow-tech-notes")` - for details regarding technical aspects as authentication and file management
