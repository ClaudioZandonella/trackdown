...
> From `trackdown` v1.3.0 (still in development), the `trackdown` package uses its own API credentials (OAuth client ID and secret; see `vignette("trackdown-privacy-policy")`). 
