...
if(isTRUE(trackdown:::.is_pkgdown)){
  JOSS_fig <- "JOSS-fig-pkgdown.png"
  rich_text <- "rich-text-pkgdown.png"
  Example_edit <- "Example-edit-pkgdown.png"
} else {
  JOSS_fig <- "JOSS-fig.png"
  rich_text <- "rich-text.png"
  Example_edit <- "Example-edit.png"
}
```
...
knitr::include_graphics("trackdown-workflow.png")
```
