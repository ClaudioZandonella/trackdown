...
> The following Privacy Policy notes are valid for `trackdown` v1.3.0 (still in development)
...
- Drive (read/write): The `trackdown` package allows you to upload and download files to your Drive and therefore the default scopes include read/write access.

- Docs (read/write): The `trackdown` package allows you to modify your Docs documents and therefore the default scopes include read/write access.
