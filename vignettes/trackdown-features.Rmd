---
title: "trackdown Functions Arguments and Features"
...
The main idea behind the `trackdown` workflow is very simple: upload the `.Rmd` (or `.Rnw`) document to Google Drive for collaborative prose writing in Google Docs and download the document locally to continue working on the code using Git (See `vignette("trackdow-workflow")`). 
