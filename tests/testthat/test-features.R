...
test_that("remove_google_comments works correctly with comments", {
  ...
  # rmd
  comments <- readLines(paste0(file_path, "features/comments.Rmd"), warn = FALSE, encoding = "UTF-8")
  no_comments <- readLines(paste0(file_path, "features/no-comments.Rmd"), warn = FALSE, encoding = "UTF-8")
  expect_snapshot_output(remove_google_comments(comments))
  expect_snapshot_output(remove_google_comments(no_comments))
  
  # rnw
  comments <- readLines(paste0(file_path, "features/comments.Rnw"), warn = FALSE, encoding = "UTF-8")
  no_comments <- readLines(paste0(file_path, "features/no-comments.Rnw"), warn = FALSE, encoding = "UTF-8")
  expect_snapshot_output(remove_google_comments(comments))
  expect_snapshot_output(remove_google_comments(no_comments))
})
...
test_that("remove_google_comments works correctly with one comment", {
  ...
  # rmd
  one_comments <- readLines(paste0(file_path, "features/one-comments.Rmd"), warn = FALSE, encoding = "UTF-8")
