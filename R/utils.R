...
get_instructions <- function(file_info, hide_code){
  ...
  instructions <- c(
    ...
    sprintf("This is not a common Document. The Document includes properly formatted %s syntax and R code. Please be aware and responsible in making corrections as you could break the code. Limit changes to plain text and avoid modifying R code.",
            language),
    placeholder1,
